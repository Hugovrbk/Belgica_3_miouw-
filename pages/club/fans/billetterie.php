...
<head>
    ...
    <title>Billetterie 25/26 — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        <div class="page-breadcrumb">
            ...
            <span class="breadcrumb-sep">›</span>
            <span>Billetterie 25/26</span>
        </div>
        <h1 class="page-h1">Billetterie 25/26</h1>
        <p class="page-desc">Achetez vos billets pour les matchs du RFC Liège à domicile.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Prochains matchs à domicile</h2>
            <?php
            ...
            <?php foreach($upcoming as $um): ?>
                <div style="background:#fff;border:1px solid #EBEBEB;border-left:5px solid var(--rouge);border-radius:10px;padding:20px 24px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:14px;">
                    <div>
                        ...
                        <div style="font-size:0.84rem;color:#888;margin-top:4px;">📅 <?= (new DateTime($um['date_match']))->format('d/m/Y') ?> · 🕐 <?= (new DateTime($um['date_match']))->format('H:i') ?> · 📍 <?= htmlspecialchars($um['stade']) ?></div>
                    </div>
        ...
        <section class="content-section">
            <h2 class="content-h2">Tarifs au match</h2>
            <div class="content-grid-2">
                <div class="content-card" style="padding:22px;"><h3>Tribune populaire</h3><div style="font-family:'Bebas Neue',sans-serif;font-size:2rem;color:var(--rouge);margin:6px 0;">10 €</div><p style="font-size:0.86rem;color:#666;">Place debout · Secteur supporters</p></div>
                <div class="content-card" style="padding:22px;"><h3>Tribune principale</h3><div style="font-family:'Bebas Neue',sans-serif;font-size:2rem;color:var(--rouge);margin:6px 0;">15 €</div><p style="font-size:0.86rem;color:#666;">Place assise numérotée</p></div>
                <div class="content-card" style="padding:22px;"><h3>Tarif réduit</h3><div style="font-family:'Bebas Neue',sans-serif;font-size:2rem;color:var(--rouge);margin:6px 0;">7 €</div><p style="font-size:0.86rem;color:#666;">- 18 ans · Seniors · Demandeurs d'emploi</p></div>
                <div class="content-card" style="padding:22px;"><h3>Enfants - 6 ans</h3><div style="font-family:'Bebas Neue',sans-serif;font-size:2rem;color:var(--rouge);margin:6px 0;">Gratuit</div><p style="font-size:0.86rem;color:#666;">Accompagnés d'un adulte payant</p></div>
            </div>
        </section>

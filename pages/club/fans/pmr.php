...
<head>
    ...
    <title>PMR au stade — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        <div class="page-breadcrumb">
            ...
            <span class="breadcrumb-sep">›</span>
            <span>PMR au stade</span>
        </div>
        <h1 class="page-h1">PMR au stade</h1>
        <p class="page-desc">Accessibilité et services pour les personnes à mobilité réduite au Stade de Rocourt.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Accueil PMR</h2>
            <div class="content-text"><p>Le RFC Liège s'engage à rendre le Stade de Rocourt <strong>accessible à tous</strong>, y compris aux personnes à mobilité réduite. Des aménagements spécifiques ont été mis en place pour garantir une expérience match confortable et sécurisée.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Nos services PMR</h2>
            <div class="content-grid-2">
                <div class="content-card" style="text-align:center;padding:26px;"><div style="font-size:2.4rem;margin-bottom:10px;">🅿️</div><h3>Parking réservé</h3><p style="margin-top:8px;">Places de parking PMR réservées à proximité immédiate de l'entrée accessible du stade.</p></div>
                <div class="content-card" style="text-align:center;padding:26px;"><div style="font-size:2.4rem;margin-bottom:10px;">♿</div><h3>Zone PMR en tribune</h3><p style="margin-top:8px;">Espace réservé en tribune principale avec accompagnateur, vue dégagée sur le terrain.</p></div>
                <div class="content-card" style="text-align:center;padding:26px;"><div style="font-size:2.4rem;margin-bottom:10px;">🚽</div><h3>Sanitaires adaptés</h3><p style="margin-top:8px;">Toilettes adaptées accessibles aux personnes en fauteuil roulant dans les deux tribunes.</p></div>
                <div class="content-card" style="text-align:center;padding:26px;"><div style="font-size:2.4rem;margin-bottom:10px;">💰</div><h3>Tarif réduit</h3><p style="margin-top:8px;">Billet à tarif réduit pour la personne PMR + entrée gratuite pour l'accompagnateur.</p></div>
            </div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Réservation & informations</h2>
            <div class="info-box"><p>Pour réserver votre place PMR à l'avance ou pour tout renseignement sur l'accessibilité du stade, contactez-nous à <strong>pmr@rfcliege.be</strong> ou au +32 (0)4 XXX XX XX (Mercredi & Samedi 9h–12h).</p></div>
        </section>

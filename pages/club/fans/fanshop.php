...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        ...
        <h1 class="page-h1">Fanshop</h1>
        <p class="page-desc">La boutique officielle du RFC Liège — maillots, accessoires et produits dérivés.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">La boutique officielle</h2>
            <div class="content-text"><p>Le Fanshop officiel du RFC Liège propose tous les produits aux couleurs sang et marine : maillots officiels, écharpes, bonnets, accessoires et cadeaux. Retrouvez-nous au stade ou commandez en ligne.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Nos produits</h2>
            <div class="content-grid-4">
                <div class="content-card" style="text-align:center;padding:24px 16px;"><div style="font-size:2.5rem;margin-bottom:10px;">🎽</div><h3>Maillot domicile</h3><div style="font-family:'Bebas Neue',sans-serif;font-size:1.6rem;color:var(--rouge);margin:6px 0;">65 €</div><p style="font-size:0.82rem;color:#666;">Maillot officiel 2025–26 · Tailles XS–4XL</p></div>
                <div class="content-card" style="text-align:center;padding:24px 16px;"><div style="font-size:2.5rem;margin-bottom:10px;">🔵</div><h3>Maillot extérieur</h3><div style="font-family:'Bebas Neue',sans-serif;font-size:1.6rem;color:var(--rouge);margin:6px 0;">65 €</div><p style="font-size:0.82rem;color:#666;">Maillot away 2025–26 · Tailles XS–4XL</p></div>
                <div class="content-card" style="text-align:center;padding:24px 16px;"><div style="font-size:2.5rem;margin-bottom:10px;">🧣</div><h3>Écharpe officielle</h3><div style="font-family:'Bebas Neue',sans-serif;font-size:1.6rem;color:var(--rouge);margin:6px 0;">18 €</div><p style="font-size:0.82rem;color:#666;">Écharpe brodée aux couleurs du club</p></div>
                <div class="content-card" style="text-align:center;padding:24px 16px;"><div style="font-size:2.5rem;margin-bottom:10px;">🧢</div><h3>Casquette RFC</h3><div style="font-family:'Bebas Neue',sans-serif;font-size:1.6rem;color:var(--rouge);margin:6px 0;">22 €</div><p style="font-size:0.82rem;color:#666;">Casquette snapback logo brodé</p></div>
            </div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Accès au Fanshop</h2>
            <div class="content-grid-2">
                <div style="display:flex;align-items:center;gap:14px;padding:18px;background:#fff;border:1px solid #EBEBEB;border-radius:10px;"><span style="font-size:1.6rem;">📍</span><div><div style="font-size:0.7rem;font-weight:900;letter-spacing:0.12em;text-transform:uppercase;color:#888;margin-bottom:3px;">Au stade</div><div style="font-weight:700;color:var(--navy);">Stade de Rocourt · Porte principale<br>Samedi 9h–13h · Jours de match: -1h/+30min</div></div></div>
                <div style="display:flex;align-items:center;gap:14px;padding:18px;background:#fff;border:1px solid #EBEBEB;border-radius:10px;"><span style="font-size:1.6rem;">✉️</span><div><div style="font-size:0.7rem;font-weight:900;letter-spacing:0.12em;text-transform:uppercase;color:#888;margin-bottom:3px;">Commande en ligne</div><div style="font-weight:700;color:var(--navy);">shop@rfcliege.be<br>Livraison sous 3–5 jours ouvrables</div></div></div>
            </div>
        </section>

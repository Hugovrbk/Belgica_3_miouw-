...
<head>
    ...
    <title>Clubs de supporters — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        <div class="page-breadcrumb">
            ...
            <span class="breadcrumb-sep">›</span>
            <span>Clubs de supporters</span>
        </div>
        <h1 class="page-h1">Clubs de supporters</h1>
        <p class="page-desc">Les clubs et associations de supporters officiels du RFC Liège.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Nos clubs de supporters</h2>
            <div class="content-text"><p>Le RFC Liège compte plusieurs <strong>clubs de supporters officiels</strong> reconnus par le club. Ces associations jouent un rôle essentiel dans l'animation des tribunes et dans la vie communautaire autour du club.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Clubs affiliés</h2>
            <div class="content-grid-2">
                <div class="content-card" style="padding:24px;border-left:4px solid var(--rouge);"><h3>Ultras Liège</h3><p style="margin-top:8px;">Groupe ultra historique du RFC Liège, actif depuis les années 90. Tribune nord, animations et tifos.</p><p style="margin-top:8px;font-size:0.84rem;color:var(--rouge);font-weight:700;">Contact : ultras@rfcliege.be</p></div>
                <div class="content-card" style="padding:24px;border-left:4px solid var(--rouge);"><h3>Marines 1892</h3><p style="margin-top:8px;">Association familiale de supporters, ouverte à tous les âges. Organisation de voyages et événements.</p><p style="margin-top:8px;font-size:0.84rem;color:var(--rouge);font-weight:700;">Contact : marines1892@rfcliege.be</p></div>
                <div class="content-card" style="padding:24px;border-left:4px solid var(--rouge);"><h3>Young Sang & Marine</h3><p style="margin-top:8px;">Club de jeunes supporters (- 25 ans) avec des activités spécifiques et un tarif préférentiel.</p><p style="margin-top:8px;font-size:0.84rem;color:var(--rouge);font-weight:700;">Contact : youngfans@rfcliege.be</p></div>
                <div class="content-card" style="padding:24px;border-left:4px solid var(--rouge);"><h3>Supporters Seniors</h3><p style="margin-top:8px;">Club des supporters de plus de 60 ans, avec accès facilité au stade et activités sociales.</p><p style="margin-top:8px;font-size:0.84rem;color:var(--rouge);font-weight:700;">Contact : seniors@rfcliege.be</p></div>
            </div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Créer un club officiel</h2>
            <div class="info-box"><p>Vous souhaitez créer un nouveau club de supporters officiel du RFC Liège ? Contactez-nous à <strong>supporters@rfcliege.be</strong> pour connaître les démarches d'affiliation.</p></div>
        </section>

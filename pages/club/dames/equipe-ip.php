...
<head>
    ...
    <title>Équipe IP — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        ...
        <h1 class="page-h1">Équipe IP</h1>
        <p class="page-desc">L'équipe IP (Interprovinciaal) Dames du RFC Liège.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Équipe Interprovinciaal (IP)</h2>
            <div class="content-text"><p>L'équipe IP Dames du RFC Liège évolue en <strong>championnat Interprovincial féminin</strong>. Cette division constitue le deuxième niveau de la section féminine du club, avec pour objectif à terme la montée en division nationale.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Résultats récents</h2>
            <div style="display:flex;flex-direction:column;gap:8px;">
                <div style="background:#fff;border:1px solid #EBEBEB;border-left:4px solid #1aaf5d;border-radius:8px;padding:14px 20px;display:flex;justify-content:space-between;align-items:center;"><span style="font-family:'Barlow Condensed',sans-serif;font-weight:700;">Waremme · 0 – 2 · RFC Liège IP</span><span style="font-size:0.78rem;color:#888;">4 mars 2026</span></div>
                <div style="background:#fff;border:1px solid #EBEBEB;border-left:4px solid #1aaf5d;border-radius:8px;padding:14px 20px;display:flex;justify-content:space-between;align-items:center;"><span style="font-family:'Barlow Condensed',sans-serif;font-weight:700;">RFC Liège IP · 4 – 0 · Herstal F</span><span style="font-size:0.78rem;color:#888;">22 fév. 2026</span></div>
            </div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Contact section IP</h2>
            <div class="info-box"><p>Pour rejoindre l'équipe IP ou pour toute information : <strong>dames.ip@rfcliege.be</strong></p></div>
        </section>

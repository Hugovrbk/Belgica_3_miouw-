...
<head>
    ...
    <title>Accréditation — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        ...
        <h1 class="page-h1">Accréditation</h1>
        <p class="page-desc">Demandez votre accréditation presse pour couvrir les matchs du RFC Liège.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Accréditations médias</h2>
            <div class="content-text"><p>Le RFC Liège facilite le travail des journalistes et médias accrédités. Nos attachés de presse sont disponibles avant et après chaque rencontre pour organiser des interviews avec le staff ou les joueurs.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Types d'accréditation</h2>
            <div class="content-grid-2">
                <div class="content-card" style="padding:22px;border-top:4px solid var(--rouge);"><h3>📸 Photo</h3><p style="margin-top:8px;">Accès à la zone photo autour du terrain. Matériel professionnel requis. Dossard obligatoire.</p></div>
                <div class="content-card" style="padding:22px;border-top:4px solid var(--rouge);"><h3>🎥 Vidéo/TV</h3><p style="margin-top:8px;">Position caméra réservée en tribune de presse. Demande à faire 5 jours à l'avance.</p></div>
                <div class="content-card" style="padding:22px;border-top:4px solid var(--rouge);"><h3>🖊 Presse écrite</h3><p style="margin-top:8px;">Accès à la tribune de presse. Interview players & coach en salle de conférence après le match.</p></div>
                <div class="content-card" style="padding:22px;border-top:4px solid var(--rouge);"><h3>📻 Radio</h3><p style="margin-top:8px;">Position commentateur en tribune de presse avec ligne téléphonique dédiée.</p></div>
            </div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Demander une accréditation</h2>
            <div style="background:#fff;border-radius:12px;padding:32px;border:1px solid #EBEBEB;">
                <form style="display:flex;flex-direction:column;gap:14px;" onsubmit="return false;">
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
                        <div><label style="display:block;font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:6px;">Nom & Prénom</label><input type="text" placeholder="Votre nom" style="width:100%;padding:12px 16px;border:1px solid #ddd;border-radius:8px;font-size:0.94rem;"></div>
                        <div><label style="display:block;font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:6px;">Média</label><input type="text" placeholder="Nom de votre média" style="width:100%;padding:12px 16px;border:1px solid #ddd;border-radius:8px;font-size:0.94rem;"></div>
                        <div><label style="display:block;font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:6px;">Type d'accréditation</label><select style="width:100%;padding:12px 16px;border:1px solid #ddd;border-radius:8px;font-size:0.94rem;"><option>Photo</option><option>Vidéo/TV</option><option>Presse écrite</option><option>Radio</option></select></div>
                        <div><label style="display:block;font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:6px;">Email professionnel</label><input type="email" placeholder="vous@media.be" style="width:100%;padding:12px 16px;border:1px solid #ddd;border-radius:8px;font-size:0.94rem;"></div>
                    </div>
                    <button type="submit" style="background:var(--rouge);color:#fff;border:none;padding:14px 32px;border-radius:8px;font-family:'Barlow Condensed',sans-serif;font-size:0.95rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;cursor:pointer;">📋 Envoyer la demande</button>
                </form>
            </div>
        </section>

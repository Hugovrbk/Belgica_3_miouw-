...
<head>
    ...
    <title>Magazine — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        ...
        <h1 class="page-h1">Magazine</h1>
        <p class="page-desc">Le magazine officiel du RFC Liège — actualités approfondies et coulisses du club.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Le magazine officiel RFC Liège</h2>
            <div class="content-text"><p>Le <strong>magazine officiel du RFC Liège</strong> est publié à chaque match à domicile. Il contient des analyses approfondies, des interviews exclusives des joueurs et du staff, les infos du club et un regard sur l'adversaire du jour. Disponible au Fanshop et aux entrées du stade.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Dernières parutions</h2>
            <div class="content-grid-2">
                <div class="content-card" style="padding:22px;display:flex;gap:14px;align-items:flex-start;">
                    <div style="width:60px;height:80px;background:linear-gradient(135deg,var(--rouge),#8B0000);border-radius:6px;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-family:'Bebas Neue',sans-serif;font-size:0.8rem;color:#fff;text-align:center;line-height:1.2;">RFC<br>MAG</div>
                    <div><h3 style="font-size:0.98rem;">Édition #14 — RFC Liège vs Seraing</h3><p style="margin-top:6px;font-size:0.84rem;color:#888;">Interview du buteur du match, analyse tactique et focus sur l'adversaire.</p><p style="margin-top:6px;font-size:0.78rem;color:var(--rouge);font-weight:700;">7 mars 2026 · 2 €</p></div>
                </div>
                <div class="content-card" style="padding:22px;display:flex;gap:14px;align-items:flex-start;">
                    <div style="width:60px;height:80px;background:linear-gradient(135deg,var(--navy),#0a0f1e);border-radius:6px;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-family:'Bebas Neue',sans-serif;font-size:0.8rem;color:#fff;text-align:center;line-height:1.2;">RFC<br>MAG</div>
                    <div><h3 style="font-size:0.98rem;">Édition #13 — RFC Liège vs Dender</h3><p style="margin-top:6px;font-size:0.84rem;color:#888;">Portrait du capitaine, coulisses des entraînements et historique du derby.</p><p style="margin-top:6px;font-size:0.78rem;color:var(--rouge);font-weight:700;">21 fév. 2026 · 2 €</p></div>
                </div>
            </div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Annonce publicitaire dans le magazine</h2>
            <div class="info-box"><p>Votre entreprise souhaite apparaître dans le magazine officiel du RFC Liège ? Contactez notre service commercial : <strong>magazine@rfcliege.be</strong></p></div>
        </section>

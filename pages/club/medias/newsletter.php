...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        ...
        <p class="page-desc">La newsletter officielle du RFC Liège pour les médias et la presse.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Newsletter presse</h2>
            <div class="content-text"><p>Inscrivez-vous à notre newsletter presse pour recevoir en avant-première les communiqués officiels, convocations en conférence de presse, et informations exclusives du RFC Liège réservées aux médias accrédités.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">S'inscrire</h2>
            <div style="background:#fff;border-radius:12px;padding:36px;border:1px solid #EBEBEB;max-width:560px;">
                <form style="display:flex;flex-direction:column;gap:16px;" onsubmit="return false;">
                    ...
                    <div><label style="display:block;font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:6px;">Média / Organisation</label><input type="text" placeholder="Nom de votre média" style="width:100%;padding:12px 16px;border:1px solid #ddd;border-radius:8px;font-size:0.94rem;"></div>
                    ...
                    <button type="submit" style="background:var(--rouge);color:#fff;border:none;padding:14px 32px;border-radius:8px;font-family:'Barlow Condensed',sans-serif;font-size:0.95rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;cursor:pointer;">✉️ S'inscrire à la newsletter presse</button>
                </form>
            </div>
        </section>

...
<head>
    ...
    <title>Stade de Rocourt — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        <div class="page-breadcrumb">
            ...
            <span class="breadcrumb-sep">›</span>
            <span>Stade de Rocourt</span>
        </div>
        <h1 class="page-h1">Stade de Rocourt</h1>
        <p class="page-desc">Présentation du Stade de Rocourt, antre du RFC Liège.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Le Stade de Rocourt</h2>
            <div class="content-text"><p>Le Stade de Rocourt est l'enceinte historique du Royal Football Club de Liège. Situé dans le quartier de Rocourt, en périphérie liégeoise, ce stade est le temple du football sang et marine. Il accueille les matchs à domicile de l'équipe première en Challenger Pro League ainsi que ceux de l'académie.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Informations pratiques</h2>
            <div class="content-grid-2">
                <div style="display:flex;align-items:center;gap:16px;padding:18px 22px;background:#fff;border:1px solid #EBEBEB;border-radius:10px;"><span style="font-size:1.8rem;">📍</span><div><div style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:3px;">Adresse</div><div style="font-weight:700;color:var(--navy);">Rue de Vottem, 4020 Liège</div></div></div>
                <div style="display:flex;align-items:center;gap:16px;padding:18px 22px;background:#fff;border:1px solid #EBEBEB;border-radius:10px;"><span style="font-size:1.8rem;">🏟</span><div><div style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:3px;">Capacité</div><div style="font-weight:700;color:var(--navy);">8 500 places (pelouse naturelle)</div></div></div>
                <div style="display:flex;align-items:center;gap:16px;padding:18px 22px;background:#fff;border:1px solid #EBEBEB;border-radius:10px;"><span style="font-size:1.8rem;">🚗</span><div><div style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:3px;">Parking</div><div style="font-weight:700;color:var(--navy);">Gratuit — accès Rue de Vottem</div></div></div>
                <div style="display:flex;align-items:center;gap:16px;padding:18px 22px;background:#fff;border:1px solid #EBEBEB;border-radius:10px;"><span style="font-size:1.8rem;">🚌</span><div><div style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:3px;">Transport en commun</div><div style="font-weight:700;color:var(--navy);">TEC ligne 48 — arrêt Stade</div></div></div>
            </div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Location du stade</h2>
            <div class="content-text"><p>Le Stade de Rocourt est disponible à la location pour des événements privés, corporate ou sportifs. Pour toute demande : <strong>stade@rfcliege.be</strong></p></div>
        </section>

...
<head>
    ...
    <title>Sang & Marine — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        <div class="page-breadcrumb">
            ...
            <span class="breadcrumb-sep">›</span>
            <span>Sang & Marine</span>
        </div>
        <h1 class="page-h1">Sang & Marine</h1>
        <p class="page-desc">L'identité visuelle et les couleurs historiques du RFC Liège.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Les couleurs sang & marine</h2>
            <div class="content-text"><p>Le <strong>rouge sang</strong> et le <strong>bleu marine</strong> sont les deux couleurs identitaires du RFC Liège depuis sa fondation en 1892. Plus qu'un simple choix esthétique, ces couleurs représentent l'âme du club et l'identité de toute une région. «&#160;Sang et Marine&#160;» est à la fois un cri de ralliement et un engagement de fidélité envers le Doyen du football belge.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Signification des couleurs</h2>
            <div class="content-grid-2">
                <div class="content-card" style="text-align:center;padding:32px 20px;">
                    <div style="width:80px;height:80px;background:#C8102E;border-radius:50%;margin:0 auto 16px;"></div>
                    <h3>Le Rouge Sang</h3>
                    <p style="margin-top:10px;">Symbole de passion, d'ardeur et de combat. Le rouge sang incarne la détermination sans limite des joueurs et supporters liégeois.</p>
                </div>
                <div class="content-card" style="text-align:center;padding:32px 20px;">
                    <div style="width:80px;height:80px;background:#1A1F3A;border-radius:50%;margin:0 auto 16px;"></div>
                    <h3>Le Bleu Marine</h3>
                    <p style="margin-top:10px;">Symbole de noblesse, de profondeur et d'histoire. Le marine représente la tradition et les racines profondes du club dans la cité ardente.</p>
                </div>
            </div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Charte graphique officielle</h2>
            <div class="info-box"><p>Pour toute utilisation du logo et des couleurs officielles du RFC Liège (médias, partenaires, événements), veuillez contacter notre service communication : <strong>communication@rfcliege.be</strong></p></div>
        </section>

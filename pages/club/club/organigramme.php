...
<head>
    ...
    <title>Organigramme — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        ...
        <h1 class="page-h1">Organigramme</h1>
        <p class="page-desc">Structure organisationnelle et dirigeants du RFC Liège.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Direction du club</h2>
            <div class="content-text"><p>Le RFC Liège est administré par un conseil d'administration et une direction exécutive dédiés au développement sportif et économique du club. Voici la structure organisationnelle du Royal Football Club de Liège pour la saison 2025–2026.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Conseil d'administration</h2>
            <div class="content-grid-2">
                <div class="content-card" style="display:flex;align-items:center;gap:16px;padding:20px;">
                    <div style="width:54px;height:54px;background:var(--rouge);border-radius:50%;display:flex;align-items:center;justify-content:center;font-family:'Bebas Neue',sans-serif;font-size:1.4rem;color:#fff;flex-shrink:0;">P</div>
                    <div><div style="font-family:'Barlow Condensed',sans-serif;font-size:1.1rem;font-weight:700;color:var(--navy);">Président</div><div style="font-size:0.8rem;color:#888;margin-top:2px;">Président du Conseil d'Administration</div></div>
                </div>
                <div class="content-card" style="display:flex;align-items:center;gap:16px;padding:20px;">
                    <div style="width:54px;height:54px;background:var(--navy);border-radius:50%;display:flex;align-items:center;justify-content:center;font-family:'Bebas Neue',sans-serif;font-size:1.4rem;color:#fff;flex-shrink:0;">DG</div>
                    <div><div style="font-family:'Barlow Condensed',sans-serif;font-size:1.1rem;font-weight:700;color:var(--navy);">Directeur Général</div><div style="font-size:0.8rem;color:#888;margin-top:2px;">Gestion opérationnelle du club</div></div>
                </div>
                <div class="content-card" style="display:flex;align-items:center;gap:16px;padding:20px;">
                    <div style="width:54px;height:54px;background:var(--rouge);border-radius:50%;display:flex;align-items:center;justify-content:center;font-family:'Bebas Neue',sans-serif;font-size:1.4rem;color:#fff;flex-shrink:0;">DS</div>
                    <div><div style="font-family:'Barlow Condensed',sans-serif;font-size:1.1rem;font-weight:700;color:var(--navy);">Directeur Sportif</div><div style="font-size:0.8rem;color:#888;margin-top:2px;">Politique sportive & recrutement</div></div>
                </div>
                <div class="content-card" style="display:flex;align-items:center;gap:16px;padding:20px;">
                    <div style="width:54px;height:54px;background:var(--navy);border-radius:50%;display:flex;align-items:center;justify-content:center;font-family:'Bebas Neue',sans-serif;font-size:1.4rem;color:#fff;flex-shrink:0;">DF</div>
                    <div><div style="font-family:'Barlow Condensed',sans-serif;font-size:1.1rem;font-weight:700;color:var(--navy);">Directeur Financier</div><div style="font-size:0.8rem;color:#888;margin-top:2px;">Gestion comptable & partenariats</div></div>
                </div>
            </div>
        </section>

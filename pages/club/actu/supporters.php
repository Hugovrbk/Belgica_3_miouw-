...
<head>
    ...
    <title>Supporters — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        ...
        <h1 class="page-h1">Supporters</h1>
        <p class="page-desc">News et informations à destination des supporters du RFC Liège.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Info supporters</h2>
            <div class="content-text"><p>Tout ce que les supporters sang et marine doivent savoir : organisation des déplacements, informations sur les matchs à domicile, billets, règlement et vie des groupes de supporters.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Prochains déplacements</h2>
            <div class="info-box"><p>🚌 <strong>Bus supporters</strong> organisé pour le prochain déplacement. Départ du Stade de Rocourt à 17h00. Places limitées — inscription obligatoire avant le vendredi 14 mars. Contact : supporters@rfcliege.be</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Groupes de supporters</h2>
            <div class="content-grid-2">
                <div class="content-card" style="text-align:center;padding:28px 20px;">
                    <div style="font-size:2.5rem;margin-bottom:12px;">🔴</div>
                    <h3>Ultras Liège</h3>
                    <p style="margin-top:8px;">Groupe ultra historique du RFC Liège, actif depuis les années 90 en tribune nord.</p>
                </div>
                <div class="content-card" style="text-align:center;padding:28px 20px;">
                    <div style="font-size:2.5rem;margin-bottom:12px;">⚓</div>
                    <h3>Marines 1892</h3>
                    <p style="margin-top:8px;">Groupe de supporters familiaux promouvant les valeurs du club depuis la création.</p>
                </div>
            </div>
        </section>

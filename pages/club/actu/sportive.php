...
<head>
    ...
    <title>Sportive — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        ...
        <h1 class="page-h1">Sportive</h1>
        <p class="page-desc">Actualités sportives de l'équipe première du RFC Liège.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Actualités sportives</h2>
            <div class="content-text"><p>Toute l'actualité sportive de l'équipe première du RFC Liège en Challenger Pro League : analyses de matchs, blessures, compositions d'équipe, tactiques et points de presse du staff technique.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Dernières nouvelles</h2>
            <div class="content-grid-2">
                <div class="content-card" style="padding:20px;">
                    <p style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:var(--rouge);">Blessure · 9 mars 2026</p>
                    <h3 style="margin:8px 0;">Point médical après le match</h3>
                    <p>Le staff médical fait le point sur les joueurs touchés lors de la dernière rencontre. Retour prévu dans 2 semaines.</p>
                </div>
                <div class="content-card" style="padding:20px;">
                    <p style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:var(--rouge);">Analyse · 8 mars 2026</p>
                    <h3 style="margin:8px 0;">Débrief tactique de la victoire</h3>
                    <p>Retour en chiffres et en images sur la performance collective de l'équipe lors du dernier match à domicile.</p>
                </div>
                <div class="content-card" style="padding:20px;">
                    <p style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:var(--rouge);">Entraînement · 6 mars 2026</p>
                    <h3 style="margin:8px 0;">Reprise après la trêve internationale</h3>
                    <p>Le groupe est au complet pour préparer les échéances décisives du mois de mars.</p>
                </div>
                <div class="content-card" style="padding:20px;">
                    <p style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:var(--rouge);">Interview · 5 mars 2026</p>
                    <h3 style="margin:8px 0;">Le coach s'exprime avant le match</h3>
                    <p>Conférence de presse d'avant-match : le coach livre ses impressions sur l'adversaire et l'état d'esprit du groupe.</p>
                </div>
            </div>
        </section>

...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        ...
        <h1 class="page-h1">Dames</h1>
        <p class="page-desc">Toutes les news de la section féminine du RFC Liège.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Actualités de la section Dames</h2>
            <div class="content-text"><p>Retrouvez ici toutes les actualités liées à la section Dames du RFC Liège : résultats des matchs, transferts, nouvelles recrues et événements à venir pour les équipes féminines sang et marine.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Derniers résultats</h2>
            <div class="content-grid-2">
                <div class="content-card" style="padding:20px;"><p style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:var(--rouge);">D1 Féminine · 5 mars 2026</p><h3 style="margin:8px 0;">RFC Liège Dames 3 – 1 Standard</h3><p>Belle victoire à domicile pour nos joueuses !</p></div>
                <div class="content-card" style="padding:20px;"><p style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:var(--rouge);">IP Féminine · 4 mars 2026</p><h3 style="margin:8px 0;">Waremme 0 – 2 RFC Liège IP</h3><p>Déplacement réussi pour l'équipe IP !</p></div>
            </div>
        </section>

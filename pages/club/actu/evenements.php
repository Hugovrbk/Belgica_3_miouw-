...
<head>
    ...
    <title>Évènements — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        ...
        <h1 class="page-h1">Évènements</h1>
        <p class="page-desc">Agenda des événements officiels et grand public du RFC Liège.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Agenda des événements</h2>
            <div class="content-text"><p>Soirées gala, journées portes ouvertes, tournois, Fan Days… Retrouvez ici tous les événements organisés ou parrainés par le RFC Liège tout au long de la saison 2025–2026.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Prochains événements</h2>
            <div class="content-grid-2">
                <div class="content-card" style="padding:22px;border-left:4px solid var(--rouge);">
                    <p style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:var(--rouge);">📅 15 mars 2026</p>
                    <h3 style="margin:8px 0;">Fan Day Printemps</h3>
                    <p>Journée portes ouvertes au stade : visite des coulisses, rencontre avec les joueurs, activités pour les enfants.</p>
                </div>
                <div class="content-card" style="padding:22px;border-left:4px solid var(--rouge);">
                    <p style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:var(--rouge);">📅 28 mars 2026</p>
                    <h3 style="margin:8px 0;">Tournoi des jeunes</h3>
                    <p>Tournoi inter-académies pour les catégories U8 à U14, organisé au Stade de Rocourt.</p>
                </div>
                <div class="content-card" style="padding:22px;border-left:4px solid var(--rouge);">
                    <p style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:var(--rouge);">📅 10 mai 2026</p>
                    <h3 style="margin:8px 0;">Soirée de gala de fin de saison</h3>
                    <p>Grande soirée officielle de clôture de la saison avec remise des trophées et buffet dînatoire.</p>
                </div>
                <div class="content-card" style="padding:22px;border-left:4px solid var(--rouge);">
                    <p style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:var(--rouge);">📅 Juin 2026</p>
                    <h3 style="margin:8px 0;">Stage été & tests académie</h3>
                    <p>Stage de préparation estival et séances de tests pour intégrer l'académie du club.</p>
                </div>
            </div>
        </section>

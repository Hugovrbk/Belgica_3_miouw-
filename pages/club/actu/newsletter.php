...
<head>
    ...
    <title>Newsletter — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        <div class="page-breadcrumb">
            ...
            <a href="./dames.php">ACTU</a>
            <span class="breadcrumb-sep">›</span>
            <span>Newsletter</span>
        </div>
        <h1 class="page-h1">Newsletter</h1>
        <p class="page-desc">Inscrivez-vous à la newsletter officielle du RFC Liège.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Restez informés</h2>
            <div class="content-text"><p>Recevez toute l'actualité du RFC Liège directement dans votre boîte mail. Résultats, transferts, billets, offres exclusives pour les abonnés — ne ratez plus aucune information importante du club.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">S'inscrire à la newsletter</h2>
            <div style="background:#fff;border-radius:12px;padding:36px;border:1px solid #EBEBEB;max-width:560px;">
                <form style="display:flex;flex-direction:column;gap:16px;" onsubmit="return false;">
                    <div><label style="display:block;font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:6px;">Prénom & Nom</label><input type="text" placeholder="Votre nom complet" style="width:100%;padding:12px 16px;border:1px solid #ddd;border-radius:8px;font-size:0.94rem;"></div>
                    <div><label style="display:block;font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:6px;">Adresse email</label><input type="email" placeholder="vous@email.com" style="width:100%;padding:12px 16px;border:1px solid #ddd;border-radius:8px;font-size:0.94rem;"></div>
                    <div style="display:flex;flex-direction:column;gap:8px;">
                        <p style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;">Je souhaite recevoir</p>
                        <label style="display:flex;align-items:center;gap:10px;font-size:0.9rem;cursor:pointer;"><input type="checkbox" checked> Résultats & matchs</label>
                        <label style="display:flex;align-items:center;gap:10px;font-size:0.9rem;cursor:pointer;"><input type="checkbox" checked> Transferts & mercato</label>
                        <label style="display:flex;align-items:center;gap:10px;font-size:0.9rem;cursor:pointer;"><input type="checkbox"> Billetterie & offres</label>
                        <label style="display:flex;align-items:center;gap:10px;font-size:0.9rem;cursor:pointer;"><input type="checkbox"> Actualités académie</label>
                    </div>
                    <button type="submit" style="background:var(--rouge);color:#fff;border:none;padding:14px 32px;border-radius:8px;font-family:'Barlow Condensed',sans-serif;font-size:0.95rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;cursor:pointer;">✉️ S'inscrire gratuitement</button>
                </form>
            </div>
        </section>

...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        ...
        <h1 class="page-h1">Jeunes</h1>
        <p class="page-desc">Actualités de l'académie et des équipes jeunes du RFC Liège.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Actualités des jeunes</h2>
            <div class="content-text"><p>Résultats, performances et nouvelles des différentes catégories jeunes de l'académie du RFC Liège. Nos jeunes talents du samedi sont les champions de demain !</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Résultats du week-end</h2>
            <div class="content-grid-2">
                <div class="content-card" style="display:flex;flex-direction:row;align-items:stretch;">
                    <div style="width:70px;flex-shrink:0;background:linear-gradient(135deg,#1a1f3a,#2a0810);display:flex;align-items:center;justify-content:center;font-family:'Bebas Neue',sans-serif;font-size:1.2rem;color:var(--rouge);">U15</div>
                    <div class="content-card-body" style="flex:1;"><h3>RFC Liège 4 – 0 Seraing</h3><p style="margin-top:4px;font-size:0.85rem;color:#888;">Victoire écrasante des U15 à domicile · 8 mars 2026</p></div>
                </div>
                <div class="content-card" style="display:flex;flex-direction:row;align-items:stretch;">
                    <div style="width:70px;flex-shrink:0;background:linear-gradient(135deg,#1a1f3a,#2a0810);display:flex;align-items:center;justify-content:center;font-family:'Bebas Neue',sans-serif;font-size:1.2rem;color:var(--rouge);">U13</div>
                    <div class="content-card-body" style="flex:1;"><h3>Herstal 1 – 3 RFC Liège</h3><p style="margin-top:4px;font-size:0.85rem;color:#888;">Beau déplacement réussi pour les U13 · 8 mars 2026</p></div>
                </div>
                <div class="content-card" style="display:flex;flex-direction:row;align-items:stretch;">
                    <div style="width:70px;flex-shrink:0;background:linear-gradient(135deg,#1a1f3a,#2a0810);display:flex;align-items:center;justify-content:center;font-family:'Bebas Neue',sans-serif;font-size:1.2rem;color:var(--rouge);">U17</div>
                    <div class="content-card-body" style="flex:1;"><h3>RFC Liège 2 – 2 Anderlecht</h3><p style="margin-top:4px;font-size:0.85rem;color:#888;">Match nul encourageant contre le champion · 7 mars 2026</p></div>
                </div>
                <div class="content-card" style="display:flex;flex-direction:row;align-items:stretch;">
                    <div style="width:70px;flex-shrink:0;background:linear-gradient(135deg,#1a1f3a,#2a0810);display:flex;align-items:center;justify-content:center;font-family:'Bebas Neue',sans-serif;font-size:1.2rem;color:var(--rouge);">U11</div>
                    <div class="content-card-body" style="flex:1;"><h3>RFC Liège 6 – 1 Visé</h3><p style="margin-top:4px;font-size:0.85rem;color:#888;">Excellente journée pour les U11 · 8 mars 2026</p></div>
                </div>
            </div>
        </section>

...
<head>
    ...
    <title>Repas VIP — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        ...
        <h1 class="page-h1">Repas VIP</h1>
        <p class="page-desc">L'hospitalité premium du RFC Liège — loges VIP et repas d'affaires au stade.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">L'expérience VIP au Stade de Rocourt</h2>
            <div class="content-text"><p>Vivez les matchs du RFC Liège dans un cadre d'exception avec l'offre <strong>Hospitalité VIP</strong>. Accueillez vos clients, collaborateurs ou partenaires dans nos loges privatisées avec restauration gastronomique et service premium.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Ce qui est inclus</h2>
            <div class="content-grid-2">
                <div class="content-card" style="text-align:center;padding:26px;"><div style="font-size:2.4rem;margin-bottom:10px;">🍽</div><h3>Repas gastronomique</h3><p style="margin-top:8px;">Accueil à partir de 1h30 avant le match avec cocktail, repas 3 services et desserts.</p></div>
                <div class="content-card" style="text-align:center;padding:26px;"><div style="font-size:2.4rem;margin-bottom:10px;">🏟</div><h3>Loge privative</h3><p style="margin-top:8px;">Loge climatisée avec vue sur le terrain, places assises numérotées et service aux tables.</p></div>
                <div class="content-card" style="text-align:center;padding:26px;"><div style="font-size:2.4rem;margin-bottom:10px;">⭐</div><h3>Service premium</h3><p style="margin-top:8px;">Hôtesses dédiées, parking réservé, programme officiel et cadeaux de bienvenue.</p></div>
                <div class="content-card" style="text-align:center;padding:26px;"><div style="font-size:2.4rem;margin-bottom:10px;">🤝</div><h3>Rencontre joueurs</h3><p style="margin-top:8px;">Possibilité de rencontrer des joueurs en coulisses selon disponibilité (sur demande).</p></div>
            </div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Tarifs & réservation</h2>
            <div class="content-grid-2">
                <div class="content-card" style="padding:24px;"><h3>Formule individuelle</h3><div style="font-family:'Bebas Neue',sans-serif;font-size:2rem;color:var(--rouge);margin:8px 0;">85 €<span style="font-size:1rem;color:#888;"> /pers.</span></div><p style="font-size:0.86rem;color:#666;">Repas + boissons + billet loge VIP · Minimum 4 personnes</p></div>
                <div class="content-card" style="padding:24px;"><h3>Loge privatisée</h3><div style="font-family:'Bebas Neue',sans-serif;font-size:2rem;color:var(--rouge);margin:8px 0;">600 €<span style="font-size:1rem;color:#888;"> /match</span></div><p style="font-size:0.86rem;color:#666;">Loge pour 8 personnes, tout compris · Personnalisation possible</p></div>
            </div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Réserver</h2>
            <div class="info-box"><p>Réservations obligatoires minimum 5 jours avant le match. Contact : <strong>vip@rfcliege.be</strong> · +32 (0)4 XXX XX XX</p></div>
        </section>

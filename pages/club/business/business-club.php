...
<head>
    ...
    <title>Business Club 1892 — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        <div class="page-breadcrumb">
            ...
            <span class="breadcrumb-sep">›</span>
            <span>Business Club 1892</span>
        </div>
        <h1 class="page-h1">Business Club 1892</h1>
        <p class="page-desc">Rejoignez le réseau Business Club 1892 du RFC Liège.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Le Business Club 1892</h2>
            <div class="content-text"><p>Le <strong>Business Club 1892</strong> est un réseau d'entrepreneurs et de dirigeants liégeois réunis autour de la passion pour le RFC Liège. Ce club exclusif offre des opportunités de networking de haut niveau dans un cadre unique — celui du football professionnel sang et marine.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Les avantages</h2>
            <div class="content-grid-2">
                <div class="content-card" style="text-align:center;padding:26px;"><div style="font-size:2.4rem;margin-bottom:10px;">🤝</div><h3>Networking exclusif</h3><p style="margin-top:8px;">Événements business réservés aux membres avec accès aux dirigeants du club et partenaires premium.</p></div>
                <div class="content-card" style="text-align:center;padding:26px;"><div style="font-size:2.4rem;margin-bottom:10px;">🏟</div><h3>Loge VIP incluse</h3><p style="margin-top:8px;">Accès loge VIP pour 2 personnes à chaque match à domicile avec restauration incluse.</p></div>
                <div class="content-card" style="text-align:center;padding:26px;"><div style="font-size:2.4rem;margin-bottom:10px;">📣</div><h3>Visibilité</h3><p style="margin-top:8px;">Logo de votre entreprise dans le magazine officiel, sur le site web et lors des événements du club.</p></div>
                <div class="content-card" style="text-align:center;padding:26px;"><div style="font-size:2.4rem;margin-bottom:10px;">🌟</div><h3>Accès privilégié</h3><p style="margin-top:8px;">Rencontres avec les joueurs, visites des coulisses et accès aux conférences de presse.</p></div>
            </div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Rejoindre le Business Club 1892</h2>
            <div class="info-box"><p>Cotisation annuelle : <strong>2 500 €</strong> (entreprise) · <strong>800 €</strong> (individuel). Pour rejoindre le Business Club 1892 : <strong>businessclub@rfcliege.be</strong> ou +32 (0)4 XXX XX XX.</p></div>
        </section>

...
<head>
    ...
    <title>Entraînements — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        ...
        <h1 class="page-h1">Entraînements</h1>
        <p class="page-desc">Horaires et lieux des entraînements de l'Académie du RFC Liège.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Horaires des entraînements</h2>
            <div class="content-text"><p>Tous les entraînements se déroulent au <strong>Stade de Rocourt</strong> ou sur les terrains annexes du club. Les horaires sont susceptibles d'être modifiés en cas de compétition ou de conditions météorologiques. Un SMS/email est envoyé en cas de changement.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Planning hebdomadaire</h2>
            <div style="display:flex;flex-direction:column;gap:0;border-radius:10px;overflow:hidden;border:1px solid #EBEBEB;">
                <div style="display:grid;grid-template-columns:1fr 1fr 1fr;background:var(--navy);color:#fff;padding:12px 20px;font-family:'Barlow Condensed',sans-serif;font-size:0.78rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;"><span>Catégorie</span><span>Jours</span><span>Horaire</span></div>
                <?php foreach([['U6–U8','Samedi','10h00–11h00'],['U9–U10','Mercredi & Samedi','16h00–17h30'],['U11–U12','Mercredi & Samedi','16h00–17h30'],['U13–U14','Mardi & Jeudi','18h00–19h30'],['U15–U16','Mardi & Jeudi','18h00–19h30'],['U17–U21','Lundi, Mercredi & Vendredi','19h00–21h00']] as $i=>[$cat,$j,$h]): $bg=$i%2===0?'#fff5f5':'#fff'; ?>
                <div style="display:grid;grid-template-columns:1fr 1fr 1fr;padding:14px 20px;background:<?= $bg ?>;border-left:3px solid var(--rouge);border-bottom:1px solid #EBEBEB;"><span style="font-weight:700;color:var(--navy);"><?= $cat ?></span><span style="color:#555;"><?= $j ?></span><span style="font-family:'Barlow Condensed',sans-serif;font-weight:700;color:var(--rouge);"><?= $h ?></span></div>
                <?php endforeach; ?>
            </div>
        </section>

...
<head>
    ...
    <title>Recrutement — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        ...
        <h1 class="page-h1">Recrutement</h1>
        <p class="page-desc">Rejoignez l'Académie du RFC Liège — informations et tests de recrutement.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Comment intégrer l'académie ?</h2>
            <div class="content-text"><p>Le RFC Liège recrute des jeunes joueurs talentueux pour toutes les catégories de son académie. Le recrutement se fait principalement via des <strong>séances de détection</strong> organisées en juin et septembre, mais des essais individuels peuvent être accordés tout au long de la saison sur demande.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Prochaines séances de détection</h2>
            <div class="content-grid-2">
                <div class="content-card" style="padding:22px;border-left:4px solid var(--rouge);"><p style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:var(--rouge);">📅 Juin 2026 — dates à confirmer</p><h3 style="margin:8px 0;">Détection été U8 – U16</h3><p>Séances de détection ouvertes à tous les jeunes joueurs nés entre 2010 et 2018. Inscription obligatoire.</p></div>
                <div class="content-card" style="padding:22px;border-left:4px solid var(--rouge);"><p style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:var(--rouge);">📅 Septembre 2026</p><h3 style="margin:8px 0;">Détection rentrée U17 – U21</h3><p>Essais pour les catégories supérieures en vue d'intégration en cours de saison.</p></div>
            </div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Postuler</h2>
            <div style="background:#fff;border-radius:12px;padding:32px;border:1px solid #EBEBEB;">
                <form style="display:flex;flex-direction:column;gap:14px;" onsubmit="return false;">
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
                        <div><label style="display:block;font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:6px;">Nom du joueur</label><input type="text" placeholder="Prénom Nom" style="width:100%;padding:12px 16px;border:1px solid #ddd;border-radius:8px;font-size:0.94rem;"></div>
                        <div><label style="display:block;font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:6px;">Date de naissance</label><input type="date" style="width:100%;padding:12px 16px;border:1px solid #ddd;border-radius:8px;font-size:0.94rem;"></div>
                        <div><label style="display:block;font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:6px;">Poste</label><select style="width:100%;padding:12px 16px;border:1px solid #ddd;border-radius:8px;font-size:0.94rem;"><option>Gardien</option><option>Défenseur</option><option>Milieu</option><option>Attaquant</option></select></div>
                        <div><label style="display:block;font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:6px;">Email parent/tuteur</label><input type="email" placeholder="email@example.com" style="width:100%;padding:12px 16px;border:1px solid #ddd;border-radius:8px;font-size:0.94rem;"></div>
                    </div>
                    <button type="submit" style="background:var(--rouge);color:#fff;border:none;padding:14px 32px;border-radius:8px;font-family:'Barlow Condensed',sans-serif;font-size:0.95rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;cursor:pointer;">⚽ Envoyer la candidature</button>
                </form>
            </div>
        </section>

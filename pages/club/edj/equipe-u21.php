...
<head>
    ...
    <title>Équipe U21 — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        <div class="page-breadcrumb">
            ...
            <span class="breadcrumb-sep">›</span>
            <span>Équipe U21</span>
        </div>
        <h1 class="page-h1">Équipe U21</h1>
        <p class="page-desc">L'équipe U21 du RFC Liège — pré-professionnelle.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">L'équipe U21</h2>
            <div class="content-text"><p>L'équipe U21 du RFC Liège constitue le <strong>dernier échelon avant l'équipe première</strong>. Ces jeunes joueurs évoluent en championnat U21 de la Challenger Pro League, dans un contexte semi-professionnel qui les prépare directement aux exigences du football de haut niveau.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Objectifs</h2>
            <div class="content-grid-2">
                <div class="content-card" style="text-align:center;padding:26px;"><div style="font-size:2.4rem;margin-bottom:12px;">⬆️</div><h3>Passerelle vers le pro</h3><p style="margin-top:8px;">Permettre aux meilleurs talents de l'académie d'intégrer l'effectif professionnel de l'équipe première.</p></div>
                <div class="content-card" style="text-align:center;padding:26px;"><div style="font-size:2.4rem;margin-bottom:12px;">🏆</div><h3>Compétition U21 CPL</h3><p style="margin-top:8px;">Participation au championnat officiel U21 de la Challenger Pro League contre les académies des clubs professionnels.</p></div>
            </div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Résultats récents U21</h2>
            <div style="display:flex;flex-direction:column;gap:8px;">
                <div style="background:#fff;border:1px solid #EBEBEB;border-left:4px solid #1aaf5d;border-radius:8px;padding:14px 20px;display:flex;justify-content:space-between;"><span style="font-family:'Barlow Condensed',sans-serif;font-weight:700;">RFC Liège U21 · 2 – 1 · Seraing U21</span><span style="font-size:0.78rem;color:#888;">8 mars 2026</span></div>
                <div style="background:#fff;border:1px solid #EBEBEB;border-left:4px solid #f0c040;border-radius:8px;padding:14px 20px;display:flex;justify-content:space-between;"><span style="font-family:'Barlow Condensed',sans-serif;font-weight:700;">Dender U21 · 1 – 1 · RFC Liège U21</span><span style="font-size:0.78rem;color:#888;">1 mars 2026</span></div>
            </div>
        </section>

...
<head>
    ...
    <title>Règlement — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        ...
        <h1 class="page-h1">Règlement</h1>
        <p class="page-desc">Règlement intérieur de l'Académie du RFC Liège.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Règlement intérieur</h2>
            <div class="content-text"><p>Ce règlement s'applique à tous les membres de l'Académie du RFC Liège — joueurs, parents et accompagnateurs. Son respect est la condition d'un bon fonctionnement du club et du bien-être de tous.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Comportement & discipline</h2>
            <div style="display:flex;flex-direction:column;gap:0;border-radius:10px;overflow:hidden;border:1px solid #EBEBEB;">
                <?php foreach(['Respecter l'entraîneur, les arbitres, les adversaires et les coéquipiers','Être ponctuel aux entraînements et matchs (présence 15 min avant l'heure)','Porter la tenue officielle du club lors des compétitions officielles','Signaler toute absence à l'entraîneur au moins 24h à l'avance','Ne pas utiliser de langage vulgaire ou irrespectueux','Prendre soin du matériel et des infrastructures du club'] as $i=>$r): $bg=$i%2===0?'#fff5f5':'#fff'; ?>
        ...
        <section class="content-section">
            <h2 class="content-h2">Sanctions</h2>
            <div class="content-text"><p>Tout manquement au règlement peut entraîner un <strong>avertissement verbal</strong>, puis écrit, puis une <strong>suspension temporaire</strong> ou définitive. Les décisions sont prises par la direction de l'académie après entretien avec le joueur et ses parents.</p></div>
        </section>

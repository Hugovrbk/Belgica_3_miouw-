...
<head>
    ...
    <title>Cotisations — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        ...
        <h1 class="page-h1">Cotisations</h1>
        <p class="page-desc">Tarifs et modalités de cotisation à l'Académie du RFC Liège.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Tarifs 2025–2026</h2>
            <div class="content-text"><p>Les cotisations couvrent l'ensemble de la saison sportive, de septembre à juin, et incluent l'affiliation à l'ACFF, les frais de compétition et l'utilisation des infrastructures du club.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Grille tarifaire</h2>
            <div class="content-grid-2">
                <div class="content-card" style="padding:24px;border-top:4px solid var(--rouge);"><h3 style="font-family:'Bebas Neue',sans-serif;font-size:1.6rem;color:var(--rouge);">U6 – U8</h3><div style="font-family:'Bebas Neue',sans-serif;font-size:2.4rem;color:var(--navy);margin:8px 0;">80 €</div><p style="font-size:0.88rem;color:#666;">Initiation au football, matériel inclus</p></div>
                <div class="content-card" style="padding:24px;border-top:4px solid var(--rouge);"><h3 style="font-family:'Bebas Neue',sans-serif;font-size:1.6rem;color:var(--rouge);">U9 – U12</h3><div style="font-family:'Bebas Neue',sans-serif;font-size:2.4rem;color:var(--navy);margin:8px 0;">120 €</div><p style="font-size:0.88rem;color:#666;">Formation technique, maillot inclus</p></div>
                <div class="content-card" style="padding:24px;border-top:4px solid var(--rouge);"><h3 style="font-family:'Bebas Neue',sans-serif;font-size:1.6rem;color:var(--rouge);">U13 – U16</h3><div style="font-family:'Bebas Neue',sans-serif;font-size:2.4rem;color:var(--navy);margin:8px 0;">160 €</div><p style="font-size:0.88rem;color:#666;">Compétition officielle, équipement complet</p></div>
                <div class="content-card" style="padding:24px;border-top:4px solid var(--rouge);"><h3 style="font-family:'Bebas Neue',sans-serif;font-size:1.6rem;color:var(--rouge);">U17 – U21</h3><div style="font-family:'Bebas Neue',sans-serif;font-size:2.4rem;color:var(--navy);margin:8px 0;">200 €</div><p style="font-size:0.88rem;color:#666;">Pré-professionnel, suivi individuel</p></div>
            </div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Modalités de paiement</h2>
            <div class="info-box"><p>Paiement par virement bancaire (IBAN communiqué à l'inscription), en espèces au secrétariat ou en 2 fois (septembre + janvier). Des réductions sont prévues à partir du 2e enfant inscrit dans le même club. Contact : <strong>cotisations@rfcliege.be</strong></p></div>
        </section>

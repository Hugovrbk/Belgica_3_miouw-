...
<head>
    ...
    <title>Secrétariat — RFC Liège</title>
...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        ...
        <h1 class="page-h1">Secrétariat</h1>
        <p class="page-desc">Coordonnées et horaires du secrétariat de l'Académie du RFC Liège.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Nous contacter</h2>
            <div class="content-grid-2">
                <div style="display:flex;align-items:center;gap:16px;padding:18px 22px;background:#fff;border:1px solid #EBEBEB;border-radius:10px;"><span style="font-size:1.8rem;">📍</span><div><div style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:3px;">Adresse</div><div style="font-weight:700;color:var(--navy);">Stade de Rocourt, Rue de Vottem, 4020 Liège</div></div></div>
                <div style="display:flex;align-items:center;gap:16px;padding:18px 22px;background:#fff;border:1px solid #EBEBEB;border-radius:10px;"><span style="font-size:1.8rem;">✉️</span><div><div style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:3px;">Email</div><div style="font-weight:700;color:var(--navy);">academie@rfcliege.be</div></div></div>
                <div style="display:flex;align-items:center;gap:16px;padding:18px 22px;background:#fff;border:1px solid #EBEBEB;border-radius:10px;"><span style="font-size:1.8rem;">📞</span><div><div style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:3px;">Téléphone</div><div style="font-weight:700;color:var(--navy);">+32 (0)4 XXX XX XX</div></div></div>
                <div style="display:flex;align-items:center;gap:16px;padding:18px 22px;background:#fff;border:1px solid #EBEBEB;border-radius:10px;"><span style="font-size:1.8rem;">🕐</span><div><div style="font-size:0.7rem;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#888;margin-bottom:3px;">Permanences</div><div style="font-weight:700;color:var(--navy);">Mercredi 15h–18h · Samedi 9h–13h</div></div></div>
            </div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Documents utiles</h2>
            <div class="content-grid-2">
                <div class="content-card" style="display:flex;align-items:center;gap:14px;padding:18px 20px;"><span style="font-size:1.8rem;">📄</span><div><h3 style="font-size:0.98rem;">Fiche d'inscription</h3><p style="margin-top:4px;font-size:0.84rem;">Formulaire à compléter pour toute nouvelle inscription.</p></div></div>
                <div class="content-card" style="display:flex;align-items:center;gap:14px;padding:18px 20px;"><span style="font-size:1.8rem;">📋</span><div><h3 style="font-size:0.98rem;">Certificat médical</h3><p style="margin-top:4px;font-size:0.84rem;">Obligatoire pour toute participation aux entraînements et matchs.</p></div></div>
                <div class="content-card" style="display:flex;align-items:center;gap:14px;padding:18px 20px;"><span style="font-size:1.8rem;">🤝</span><div><h3 style="font-size:0.98rem;">Charte parents fair-play</h3><p style="margin-top:4px;font-size:0.84rem;">À signer par les parents lors de l'inscription.</p></div></div>
                <div class="content-card" style="display:flex;align-items:center;gap:14px;padding:18px 20px;"><span style="font-size:1.8rem;">💳</span><div><h3 style="font-size:0.98rem;">RIB pour cotisations</h3><p style="margin-top:4px;font-size:0.84rem;">Coordonnées bancaires pour le paiement des cotisations.</p></div></div>
            </div>
        </section>

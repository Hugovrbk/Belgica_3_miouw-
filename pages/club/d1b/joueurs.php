...
<section class="page-banner">
    ...
    <div class="page-banner-content">
        ...
        <h1 class="page-h1">Joueurs</h1>
        <p class="page-desc">Effectif de l'équipe première du RFC Liège — saison 2025–2026.</p>
    </div>
</section>
...
<?php if($cms_r&&$cms_r["contenu"]): ?><main class="page-main"><div class="page-main-inner cms-content"><?= cms_render($cms_r["contenu"]) ?></div></main><?php else: ?><main class="page-main">
    <div class="page-main-inner">
        ...
        <section class="content-section">
            <h2 class="content-h2">Effectif 2025–2026</h2>
            <div class="content-text"><p>Découvrez l'effectif complet de l'équipe première du RFC Liège pour la saison 2025–2026. Porteurs des couleurs sang et marine, nos joueurs s'engagent chaque week-end pour la promotion en Jupiler Pro League.</p></div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Gardiens</h2>
            <div class="content-grid-4">
                <div class="content-card" style="text-align:center;padding:24px 16px;"><div style="font-family:'Bebas Neue',sans-serif;font-size:2.4rem;color:var(--rouge);line-height:1;">1</div><div style="font-family:'Barlow Condensed',sans-serif;font-size:1rem;font-weight:700;color:var(--navy);margin:6px 0 2px;">Gardien #1</div><div style="font-size:0.72rem;text-transform:uppercase;letter-spacing:0.12em;color:#888;">Gardien de but</div></div>
                <div class="content-card" style="text-align:center;padding:24px 16px;"><div style="font-family:'Bebas Neue',sans-serif;font-size:2.4rem;color:var(--rouge);line-height:1;">16</div><div style="font-family:'Barlow Condensed',sans-serif;font-size:1rem;font-weight:700;color:var(--navy);margin:6px 0 2px;">Gardien #2</div><div style="font-size:0.72rem;text-transform:uppercase;letter-spacing:0.12em;color:#888;">Gardien de but</div></div>
            </div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Défenseurs</h2>
            <div class="content-grid-4">
                <?php foreach([2,3,4,5,6,23,24] as $n): ?>
                <div class="content-card" style="text-align:center;padding:24px 16px;"><div style="font-family:'Bebas Neue',sans-serif;font-size:2.4rem;color:var(--rouge);line-height:1;"><?= $n ?></div><div style="font-family:'Barlow Condensed',sans-serif;font-size:1rem;font-weight:700;color:var(--navy);margin:6px 0 2px;">Défenseur #<?= $n ?></div><div style="font-size:0.72rem;text-transform:uppercase;letter-spacing:0.12em;color:#888;">Défenseur</div></div>
                <?php endforeach; ?>
            </div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Milieux</h2>
            <div class="content-grid-4">
                <?php foreach([7,8,10,14,18,19,20] as $n): ?>
                <div class="content-card" style="text-align:center;padding:24px 16px;"><div style="font-family:'Bebas Neue',sans-serif;font-size:2.4rem;color:var(--rouge);line-height:1;"><?= $n ?></div><div style="font-family:'Barlow Condensed',sans-serif;font-size:1rem;font-weight:700;color:var(--navy);margin:6px 0 2px;">Milieu #<?= $n ?></div><div style="font-size:0.72rem;text-transform:uppercase;letter-spacing:0.12em;color:#888;">Milieu de terrain</div></div>
                <?php endforeach; ?>
            </div>
        </section>
        <section class="content-section">
            <h2 class="content-h2">Attaquants</h2>
            <div class="content-grid-4">
                <?php foreach([9,11,17,22] as $n): ?>
                <div class="content-card" style="text-align:center;padding:24px 16px;"><div style="font-family:'Bebas Neue',sans-serif;font-size:2.4rem;color:var(--rouge);line-height:1;"><?= $n ?></div><div style="font-family:'Barlow Condensed',sans-serif;font-size:1rem;font-weight:700;color:var(--navy);margin:6px 0 2px;">Attaquant #<?= $n ?></div><div style="font-size:0.72rem;text-transform:uppercase;letter-spacing:0.12em;color:#888;">Attaquant</div></div>
                <?php endforeach; ?>
            </div>
        </section>
